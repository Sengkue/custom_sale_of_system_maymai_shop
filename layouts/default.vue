<template>
  <v-app :dark="dark">
    <head>
		...
		<meta name="Keywords" content="admin,admin dashboard,admin dashboard template,admin card template,admin template,admin theme,bootstrap 4 admin template,bootstrap 4 dashboard,bootstrap admin,bootstrap admin dashboard,bootstrap admin card,bootstrap admin template,bootstrap admin theme,bootstrap dashboard,bootstrap form template,bootstrap card,bootstrap ui kit,dashboard bootstrap 4,dashboard design,dashboard html,dashboard template,dashboard ui kit,envato templates,flat ui,html,html and css templates,html dashboard template,html5,jquery html,premium,premium quality,sidebar bootstrap 4,template admin bootstrap 4"/>
  ...
  head() {
    return {
      script: [
        ...
        { src: '/assets/plugins/bootstrap/js/bootstrap.bundle.min.js', body: true },
        { src: '/assets/plugins/ionicons/ionicons.js', body: true },
        { src: '/assets/plugins/moment/moment.js', body: true },
        { src: '/assets/plugins/perfect-scrollbar/perfect-scrollbar.min.js', body: true },
