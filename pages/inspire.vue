      ...
      <v-card>
        ...
        <v-window v-model="navigationTab">
          <v-window-item v-for="item in tabItems" :key="item" :value="item">
            <v-card-item>
              <v-cardTitle>Navigation Card</v-cardTitle>
            </v-card-item>
...
export default {
  ...
  data() {
    return {
      navigationTab: ref('ITEM ONE'),
      tabItems : [
  'ITEM ONE',
  'ITEM TWO',
  'ITEM THREE',
],
 tabContent : 'Although cards can support multiple actions, UI controls, and an overflow menu, use restraint and remember that cards...'
